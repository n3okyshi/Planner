...
export const viewRegistry = {
    ...
    apresentacoes: interatividadesView,
    slides: interatividadesView,
    powerpoint: interatividadesView,
    pptx: interatividadesView,
