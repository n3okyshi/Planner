...
export const commandPaletteController = {
    ...
    actions: [
        ...
        { id: 'interatividades', title: 'Interatividades Pedagógicas', icon: 'fas fa-shapes', category: 'Navegação', badge: 'Tela', execute: () => controller.navigate('interatividades') },
        { id: 'apresentacoes', title: 'Apresentações Animadas & Slides', icon: 'fas fa-desktop', category: 'Navegação', badge: 'Tela', execute: () => controller.navigate('apresentacoes') },
        { id: 'quiz', title: 'Quiz & Atividades Interativas ao Vivo', icon: 'fas fa-gamepad', category: 'Navegação', badge: 'Tela', execute: () => controller.navigate('quiz-gestor') },
